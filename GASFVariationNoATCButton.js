...
function getPageOffersByGroup(group) {
  ...
  return ___pageOffers
    ...
    if (offer.trackingName == "Risk-Free Trial" || offer.trackingName.includes("Risk Free Trial")) {    
        ...
        $('.pay-today-lbl').html("PAY ONLY $8.95 S&P TODAY (SAVE $100)");   
        $('.bigPic img').attr("src","conjure_resource(202ef50fbace4dfa9b038952f6e9d71c)");
        if (isDeluxe) { 
            $('.two-weeks-bag-bullet').html("Two 30-scoop Ultra Bag");  
        $(".prodDesc").html("Our RISK-FREE TRIAL offer includes preferred enrollment. With preferred enrollment you will receive two 30-scoop bags every 60 days for ONLY $119.90 + $9.95 S&P. Your First Shipment Includes:"); 
        } else {    
            $('.two-weeks-bag-bullet').html("Two 30-scoop Bags");   
        $(".prodDesc").html("Our RISK-FREE TRIAL offer includes preferred enrollment. With preferred enrollment you will receive two 30-scoop bags every 60 days for ONLY $99.90 + $9.95 S&P. Your First Shipment Includes:");  
        }   
        $('.free-14-bag').show();   
        ...
        $('.pay-today-lbl').html("Pay only $8.95 S&amp;P Today");   
        $('.bigPic img').attr("src","conjure_resource(7dc4f05186134e8790248cc52285b942)");          
        ...
        $('.bigPic img').attr("src","conjure_resource(000b3314a38b4fc9a3dd32cc09a8ad79)");  
        if (isDeluxe) { 
            ...
            $('.pay-today-lbl').html("$59.99 + $8.95 S&amp;P"); 
        }   
